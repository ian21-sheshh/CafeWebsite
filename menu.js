...
const view15 = document.querySelector(".fifthteen__view");
const view15OpenBtn = document.querySelector(".fifthteen__view__openBtn");
const view15CloseBtn = document.querySelector(".fifthteen__view__closeBtn");
const view15Overlay = document.querySelector(".fifthteen__view-overlay");

view15OpenBtn.addEventListener("click", function () {
  view15.classList.add("fifthteen__showview");
  view15Overlay.classList.add("fifthteen__transparentBcg");
  html.classList.add("no-scroll");
});

view15CloseBtn.addEventListener("click", function () {
  view15.classList.remove("fourteen__showview");
  view15Overlay.classList.remove("fifthteen__transparentBcg");
  html.classList.remove("no-scroll");
});
