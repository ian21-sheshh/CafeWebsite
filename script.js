...
if (document.querySelector(".one__cart__button")) {
  ...
  // Item 13: Caramelized-Apple-Crumble
  ...
  item13Button.addEventListener("click", function () {
    ...
    // Item 14: Four-Flavour Sheet Pan Pie
    ...
    // Item 15: Dylan Patisserie
    const item15Button = document.querySelector(".fifthteen__cart__button");
    ...
    item15Button.addEventListener("click", function () {
      ...
      updateTotal(3,50);
      Storage.setAmount("item15", item14Counter);
    });



    // Item 16: Patisserie Le Choux-Colat
    ...
    item16Button.addEventListener("click", function () {
      ...
      item16Counter++;
      item16Amount.innerHTML = item14Counter;
      updateTotal(3,50);
